...
class BedRoom:
    def __init__(self, home, listener):
        ...
        self.lights = home.please().filter(area="Bedroom", type="light", name="!Ceiling")
    ...
    def turn_on_other_lights(self):
        ...
        def doit(event):
            ...
            logger.info("Detected ceiling light, turning on bedroom")
    ...
    def turn_off_other_lights(self):
        ...
        def doit(event):
            ...
            logger.info("Lost connection from ceiling light, turning off bedroom")